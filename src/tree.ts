/**
  You should complete this file AFTER monkey.ts!
   ...
   3.3 Create a method in the Tree class named 'getTreeWeight' that has no parameters and
      returns the total weight of monkeys and their pets that are in the Tree. Note:
       use getFullWeight from Monkey class.
   3.4  Create a method named 'addMonkey' that has one Monkey parameter and returns a boolean. This method
   ...
   3.5  Create a method named 'getPairNames' that has that has no parameters and returns a string containing
